...
#ifndef STORAGE_DSMEngine_INCLUDE_OPTIONS_H_
#define STORAGE_DSMEngine_INCLUDE_OPTIONS_H_
...
struct DSMEngine_EXPORT Options {
  ...
  // Internal_and_Leaf: a comparator that uses lexicographic byte-wise ordering
  //
  ...
  // Internal_and_Leaf: Env::Internal_and_Leaf()
  Env* env;
  ...
  // If null, DSMEngine will automatically create and use an 64MB internal table_cache.
  ...
  // DSMEngine will write up to this amount of bytes to a file before
  ...
  //
  // Internal_and_Leaf: kSnappyCompression, which gives lightweight but fast
  // compression.
  //
  ...
  //
  // Internal_and_Leaf: currently false, but may become true later.
...
struct DSMEngine_EXPORT ReadOptions {
  ReadOptions() = default;
...
struct DSMEngine_EXPORT WriteOptions {
...
#endif  // STORAGE_DSMEngine_INCLUDE_OPTIONS_H_
