...
struct DSMEngine_EXPORT Options {
  ...
  // Internal: a comparator that uses lexicographic byte-wise ordering
  //
  ...
  //
  // Internal: kSnappyCompression, which gives lightweight but fast
  // compression.
  //
  ...
  //
  // Internal: currently false, but may become true later.
