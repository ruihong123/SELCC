...
#ifndef STORAGE_DSMEngine_INCLUDE_SLICE_H_
#define STORAGE_DSMEngine_INCLUDE_SLICE_H_
...
inline bool operator>(const Slice& x, const Slice& y) { return x.compare(y) == 1; }
...
#endif  // STORAGE_DSMEngine_INCLUDE_SLICE_H_
