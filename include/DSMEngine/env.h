...
//
// An Env is an interface used by the DSMEngine implementation to access
...
#ifndef STORAGE_DSMEngine_INCLUDE_ENV_H_
#define STORAGE_DSMEngine_INCLUDE_ENV_H_
...
#undef DeleteFile
#define DSMEngine_DELETEFILE_UNDEFINED
...
class DSMEngine_EXPORT Env {
 public:
  ...
  //
  // The result of Internal() belongs to DSMEngine and must never be deleted.
  static Env* Default();
  ...
  // the DSMEngine implementation) must be prepared to deal with
...
class DSMEngine_EXPORT SequentialFile {
 public:
...
class DSMEngine_EXPORT RandomAccessFile {
 public:
...
class DSMEngine_EXPORT WritableFile {
 public:
...
class DSMEngine_EXPORT FileLock {
 public:
  FileLock() = default;
...
DSMEngine_EXPORT Status WriteStringToFile(Env* env, const Slice& data,
                                        const std::string& fname);

// A utility routine: read contents of named file into *data
DSMEngine_EXPORT Status ReadFileToString(Env* env, const std::string& fname,
                                       std::string* data);

// An implementation of Env that forwards all calls to another Env.
// May be useful to clients who wish to override just part of the
// functionality of another Env.
class DSMEngine_EXPORT EnvWrapper : public Env {
 public:
...
#if defined(_WIN32) && defined(DSMEngine_DELETEFILE_UNDEFINED)
#if defined(UNICODE)
#define DeleteFile DeleteFileW
#else
#define DeleteFile DeleteFileA
#endif  // defined(UNICODE)
#endif  // defined(_WIN32) && defined(DSMEngine_DELETEFILE_UNDEFINED)

#endif  // STORAGE_DSMEngine_INCLUDE_ENV_H_
